...
<xsl:stylesheet version = '1.0' xmlns:xsl='http://www.w3.org/1999/XSL/Transform' xmlns:indivodoc="http://s1984.it.kth.se/indivo/vitals.xsd#"> 
    ...
    <facts>
      <fact>
        ...
        <xsl:if test="indivodoc:dateMeasuredEnd">
	        <date_measured_end><xsl:value-of select='indivodoc:dateMeasuredEnd/text()' /></date_measured_end>
        </xsl:if>
