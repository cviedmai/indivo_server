...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Vitals.duration'
        db.delete_column('indivo_vitals', 'duration')

        # Adding field 'Vitals.date_measured_end'
        db.add_column('indivo_vitals', 'date_measured_end', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Vitals.duration'
        db.add_column('indivo_vitals', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
