...
urlpatterns = patterns('',
    ...
    (r'^apps/$', all_phas),
    (r'^apps/(?P<pha_email>[^/]+)$', MethodDispatcher({'GET' : pha, 'DELETE': pha_delete}), {'__app_specific': True}),
    (r'^apps/(?P<pha_email>[^/]+)', include('indivo.urls.application'), {'__app_specific': True}),
